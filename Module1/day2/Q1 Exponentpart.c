...
#include <stdio.h>//header file for pre processing

//funtion to get hexadecimal and binary number 
void printExponent(double x) { //double datatype is used to print the hexadecima value
